...
- server: This folder is the ubuntu server to which the API will connect, you can use your own server instead if you have one.
...
1. Navigate to the `backend-shindow` directory:
   ...
   - Copy its content and paste it into a new file named `.env.development`.
